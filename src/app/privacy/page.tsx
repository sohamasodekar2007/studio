  ...
  return (
    <div className="max-w-3xl mx-auto py-12 px-4 sm:px-6 lg:px-8 space-y-6">
      ...
      <div className="prose prose-lg max-w-none dark:prose-invert">
        ...
        <ul>
          <li><strong>Personal Data:</strong> While using our Service, especially during sign-up and profile updates, we may ask you to provide us with certain personally identifiable information ("Personal Data"). This may include, but is not limited to: Email address, Full name.</li>
          <li><strong>Test Performance Data:</strong> To provide performance analysis and track progress, we collect data related to your test attempts, including scores, answers given, time taken per question, and overall performance metrics ("Test Performance Data").</li>
          <li><strong>AI Interaction Data:</strong> If you use AI-powered features like the Study Tips generator, we collect the inputs you provide (e.g., selected exam, subject, topic, difficulty) and the outputs generated ("AI Interaction Data"). This data is used to provide the feature and potentially improve the AI models.</li>
          <li><strong>Usage Data:</strong> We may collect information on how the Service is accessed and used ("Usage Data"), such as IP address, browser type, pages visited, and time spent.</li>
        </ul>
        ...
        <ul>
          ...
          <li>To notify you about changes to our Service or important account information.</li>
        ...
        <p>Our Study Tips generator uses third-party AI models (currently Google's Gemini models via Genkit) to process your inputs (exam, subject, topic, difficulty) and generate relevant advice. </p>
        <ul>
            ...
            <li>We use the generated tips solely to display them to you within the ExamPrep Hub platform.</li>
        ...
        <p>Your Personal Data and Test Performance Data are stored securely using Firebase services. We implement reasonable security measures (like those provided by Firebase) to protect your data. However, no internet transmission or electronic storage is 100% secure. While we strive to protect your data, we cannot guarantee its absolute security.</p>

        <h2 className="text-primary">5. Data Sharing and Service Providers</h2>
        <p>We may employ third-party companies and individuals ("Service Providers") to facilitate our Service (e.g., hosting via Firebase, AI processing via Google AI). </p>
        ...
        <p>Depending on your jurisdiction, you may have rights regarding your personal data, such as the right to access, correct, or delete your information. You can manage your profile information through the Settings page. For other requests or inquiries about your data, please contact us using the information below.</p>
        ...
        <p>If you have any questions about this Privacy Policy, please contact us at support@examprephub.app.</p>
      </div>
    </div>
  );
}
